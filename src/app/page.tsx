...
const SvgIconToday = () => (
    <svg
        ...
        height="1em"
        viewBox="0 0 576 512"
        className={'h-20 hover:fill-slate-400'}
    >
        <path
...
const SvgIconPortfolio = () => (
    <svg version="1.0" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1088 1024"
         className={'h-20 hover:fill-slate-400'}>
        <path
...
const projects = [
    ...
    },
    {
        ...
        message:
            'Dit project omvatte het ontwikkelen van een portfolio website.',
